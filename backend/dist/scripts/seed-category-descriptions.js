...
const DESCRIPTIONS = {
    kurta: 'Hand-finished ethnic kurtas in jacquard, cotton and silk blends. Cut for ' +
        'weddings, festivals and everyday wear, in chest sizes 36 to 44.',
    shirts: 'Slim-fit shirts that move between office formals and smart casual. ' +
        'Breathable fabrics, tailored through the body, in sizes M to XXL.',
    'modi-jacket': 'Sleeveless Nehru-collar jackets worn over a kurta — the quickest way to ' +
        'lift an outfit into occasion wear. Solids and textured weaves, sizes 36 to 44.',
    jacket: 'Ethnic and formal jackets, from Nehru collars to structured blazers. The ' +
        'layer that turns a kurta or a shirt into something you can wear to a wedding.',
    jodhpuri: 'Closed-collar Jodhpuri suits with matching trousers. Formal Indian ' +
        'tailoring for weddings, receptions and evening functions.',
    'open-jodhpuri': 'Open-front Jodhpuri sets, worn over a kurta for a layered silhouette. A ' +
        'lighter alternative to a closed bandhgala for daytime functions.',
    sherwani: 'Full-length sherwanis for the groom and the wedding party. Structured and ' +
        'embroidered, cut to be worn over a kurta and churidar.',
    'formal-pants': 'Ankle-length and full-length formal trousers in linen, cotton and blends. ' +
...
//# sourceMappingURL=seed-category-descriptions.js.map