...
async function run() {
    ...
    const paymentSuccessPromise = (async () => {
        await randomDelay(30);
        return paymentService.handlePaymentSuccess(payment.id, order.id, `mockpay_${now}`, { source: 'simulate-cancellation-race' });
    })();
...
//# sourceMappingURL=simulate-cancellation-race.js.map