...
export const adminController = {
     ...
     * List all sellers
     */
    listSellers: async (_req, res, next) => {
        try {
     ...
     */
    listPendingProducts: async (_req, res, next) => {
        try {
     ...
     * List all products
     */
    listAllProducts: async (_req, res, next) => {
        try {
     ...
     */
    setProductPrice: async (req, res, next) => {
        try {
            const { id } = productIdParamSchema.parse(req.params);
     ...
     */
    pricingOverview: async (_req, res, next) => {
        try {
     ...
     */
    profitAnalytics: async (_req, res, next) => {
        try {
     ...
     * List all reviews
     */
    listReviews: async (_req, res, next) => {
        try {
     ...
     */
    listBestsellers: async (_req, res, next) => {
        try {
     ...
     */
    createBestseller: async (req, res, next) => {
        try {
     ...
     */
    updateBestseller: async (req, res, next) => {
        try {
            const id = req.params['id'];
     ...
     */
    deleteBestseller: async (req, res, next) => {
        try {
            const id = req.params['id'];
     ...
     * List all orders
     */
    listOrders: async (_req, res, next) => {
        try {
     ...
     */
    forceConfirmOrder: async (req, res, next) => {
        try {
            const id = req.params['id'];
            const actorId = req.user.userId;
     ...
     * List all payments
     */
    listPayments: async (_req, res, next) => {
        try {
