...
export class FastrrController {
    ...
    async getSessionStatus(req, res, next) {
        try {
            ...
            const result = await fastrrOrderService.syncFromFastrr(session.fastrrOrderId, 'callback');
            res.json({
     ...
     */
    async getCheckoutConfig(_req, res, next) {
        try {
...
//# sourceMappingURL=fastrr.controller.js.map