...
export class ShipmentRepository {
     ...
     */
    async create(data, orderId, sellerId) {
     ...
     */
    async updateStatus(shipmentId, status, note) {
        const updateData = {
            status,
            updated_at: new Date()
        };
     ...
     */
    async existsForSellerAndOrder(sellerId, orderId) {
     ...
     */
    async countDistinctSellersInOrder(orderId) {
     ...
     */
    async areAllShipmentsAtLeast(orderId, status) {
        ...
        if (shipments.length < requiredSellers)
            return false;
