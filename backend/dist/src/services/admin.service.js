...
export class AdminService {
    ...
    async approveProduct(productId, actorId) {
        ...
        await notificationService.notifySellerProductApproved(product.sellerId, product.title, product.sellerEmail);
    ...
    async rejectProduct(productId, reason, actorId) {
        ...
        await notificationService.notifySellerProductRejected(product.sellerId, product.title, reason.trim(), product.sellerEmail);
        await invalidateProductCaches(productId);
        // Log audit action
