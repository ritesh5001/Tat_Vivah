...
export class OccasionService {
     ...
     */
    async listOccasions() {
        const cached = await getFromCache(CACHE_KEYS.OCCASIONS_LIST);
        if (cached)
            return cached;
