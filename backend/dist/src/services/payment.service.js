...
export class PaymentService {
    ...
    async verifyRazorpayPayment(userId, razorpayOrderId, razorpayPaymentId, razorpaySignature) {
        ...
        await this.handlePaymentSuccess(payment.id, razorpayPaymentId, { razorpayOrderId, razorpayPaymentId }, razorpaySignature);
        return { message: 'Payment verified', paymentId: payment.id };
    }
    async handlePaymentSuccess(paymentId, providerPaymentId, payload, providerSignature) {
