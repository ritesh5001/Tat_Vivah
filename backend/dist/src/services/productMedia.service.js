...
export class ProductMediaService {
     ...
     */
    async addMedia(productId, sellerId, input) {
        ...
        if (product.sellerId !== sellerId)
            throw ApiError.forbidden('Not product owner');
     ...
     */
    async updateMedia(mediaId, sellerId, input) {
        ...
        if (media.product.sellerId !== sellerId)
            throw ApiError.forbidden('Not product owner');
     ...
     */
    async deleteMedia(mediaId, sellerId) {
        const media = await prisma.productMedia.findUnique({
            where: { id: mediaId },
            include: { product: { select: { sellerId: true } } },
        });
...
//# sourceMappingURL=productMedia.service.js.map