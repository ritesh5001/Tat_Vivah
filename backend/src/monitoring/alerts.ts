...
import {
    inventoryReserveFailTotal,
    integrityMismatchTotal,
    paymentFailTotal,
...
const reserveAttempts: RollingWindow = { timestamps: [] };
const reserveFailures: RollingWindow = { timestamps: [] };
const paymentFailures: RollingWindow = { timestamps: [] };

function pruneWindow(w: RollingWindow): void {
 ...
 */
export function recordReserveAttempt(): void {
 ...
 */
export function recordReserveFailure(variantId: string): void {
 ...
 */
export function recordIntegrityMismatch(severity: 'CRITICAL' | 'WARNING' | 'INFO', variantId: string, reason: string): void {
