...
import { HERO_SLIDES, type HeroSlide } from "@/components/home/hero-data";
...
export function LuxuryHero({ className, suppressAspect = false }: { className?: string; suppressAspect?: boolean }) {
  ...
  return (
    <section
      className={`relative w-full overflow-hidden bg-charcoal ${suppressAspect ? "h-full" : "aspect-square md:aspect-21/8"} ${className ?? ""}`}
    >
      <Swiper
